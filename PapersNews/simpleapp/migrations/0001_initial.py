# Generated by Django 4.2.7 on 2023-12-20 08:43
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('users', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, related_name='user', to=settings.AUTH_USER_MODEL)),
            ],
        ),
        migrations.CreateModel(
            name='Category',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('author', models.ForeignKey(default=1, on_delete=django.db.models.deletion.SET_DEFAULT, to='simpleapp.author', verbose_name='Author')),
            ],
        ),
        migrations.CreateModel(
            name='PostCategory',
        ...
        migrations.AddField(
            model_name='post',
            name='category',
            field=models.ManyToManyField(through='simpleapp.PostCategory', to='simpleapp.category', verbose_name='Category'),
        ),
        migrations.CreateModel(
            name='Comment',
            fields=[
